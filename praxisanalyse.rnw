...
\noindent "Bitte beschreiben Sie uns aus Ihrer Sicht das Problem bei der Materialversorgung. Wie könnte das Problem aus Ihrer Sicht gut behoben werden?"

<<include=FALSE>>=
out2 = NULL

kommentare <- NULL
kommentare <- veranstaltungsdaten$q2_comment[!is.na(veranstaltungsdaten$q2_comment)]
