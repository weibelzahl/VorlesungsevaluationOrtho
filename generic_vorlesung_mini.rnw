...
fragen_veranstaltung <- 14 # questions per Fach
fragen_statistik <- 12 # Sonderfall Statistik in BSCO4
fragen_planspiel <- 17 # Sonderfall Planspiel in MSCO1
fragen_ethik <- 15 # Sonderfall Rechtliche Aspekte in MSCO1
fragen_werkstoffkunde <- 16 # Sonderfall Werlstoffkunde in MSCO1
fragen_praxis <- 18 # questions per Fach
fragen_modul <- 9 # questions for complete module 
