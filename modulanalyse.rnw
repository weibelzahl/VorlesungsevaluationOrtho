...
anzahl_veranstaltungen_gesamt <- anzahl_veranstaltungen + anzahl_praxis + anzahl_statistik + anzahl_planspiel + anzahl_ethik + anzahl_werkstoffkunde
...
for (v in 1:anzahl_veranstaltungen_gesamt){
  ...
  write(paste("\n i: ", i, "v: ", v), file= "logger.csv", append = TRUE) 
